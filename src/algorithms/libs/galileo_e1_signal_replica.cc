...
void galileo_e1_code_gen_float_sampled(own::span<float> dest, const std::array<char, 3>& signal_id,
    bool cboc, uint32_t prn, int32_t sampling_freq, uint32_t chip_shift, int32_t num_codes, int32_t sampling_freq_corr,
    bool secondary_flag)
{
    ...
    if (sampling_freq != samplesPerChip * codeFreqBasis)
        {
            ...
            resampler(signal_E1, resampled_signal, static_cast<float>(samplesPerChip * codeFreqBasis), sampling_freq + sampling_freq_corr);  // resamples code to fs
...
void galileo_e1_code_gen_complex_sampled(own::span<std::complex<float>> dest, const std::array<char, 3>& signal_id,
    ...
    bool secondary_flag)
{
    galileo_e1_code_gen_complex_sampled(dest, signal_id, cboc, prn, sampling_freq, chip_shift, num_codes, 0, secondary_flag);
}

void galileo_e1_code_gen_complex_sampled(own::span<std::complex<float>> dest, const std::array<char, 3>& signal_id,
    bool cboc, uint32_t prn, int32_t sampling_freq, uint32_t chip_shift, uint32_t num_codes, int32_t doppler_center,
    bool secondary_flag)
{
    ...
    int32_t sampling_freq_correction = static_cast<int32_t>((static_cast<double>(sampling_freq) * static_cast<double>(doppler_center) / 1575420000.0));

    galileo_e1_code_gen_float_sampled(real_code, signal_id, cboc, prn, sampling_freq, chip_shift, num_codes, sampling_freq_correction, secondary_flag);
...
void galileo_e1_code_gen_complex_sampled(own::span<std::complex<float>> dest, const std::array<char, 3>& signal_id,
    ...
    bool secondary_flag)
{
    galileo_e1_code_gen_complex_sampled(dest, signal_id, cboc, prn, sampling_freq, chip_shift, 1, 0, secondary_flag);
}
...
void galileo_e1_code_gen_float_sampled(own::span<float> dest, const std::array<char, 3>& signal_id,
    ...
    bool secondary_flag)
{
    galileo_e1_code_gen_float_sampled(dest, signal_id, cboc, prn, sampling_freq, chip_shift, 1, 0, secondary_flag);
}
...
void galileo_e1_code_gen_complex_sampled(own::span<std::complex<float>> dest, const std::array<char, 3>& signal_id,
    bool cboc, uint32_t prn, int32_t sampling_freq, uint32_t chip_shift)
{
    galileo_e1_code_gen_complex_sampled(dest, signal_id, cboc, prn, sampling_freq, chip_shift, 1, 0, false);
}
...
void galileo_e1_code_gen_float_sampled(own::span<float> dest, const std::array<char, 3>& signal_id,
    ...
    bool secondary_flag)
{
    galileo_e1_code_gen_float_sampled(dest, signal_id, cboc, prn, sampling_freq, chip_shift, num_codes, 0, secondary_flag);
}